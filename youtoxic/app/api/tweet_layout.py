...
tweet_layout = html.Div([
    html.Div([
        html.H2('YouToxic – Tweet Analysis',
    ...
    html.Details([
        ...
        html.Div('– Enter Twitter username, maximum number of tweets to analyze.'),
        html.Div('– Select types of toxicity to analyze tweets for.'),
        html.Div('– To select a date range, click "Limit by Date" option and make selections.'),
        html.Div('– If option "All Tweets" is selected, tweets analyzed will be the most recent.'),
        html.Div('– Due to limitations of Twitter, the maximum number of tweets to analyze is 3240.',
    ...
    html.Div([
        html.Div([
            html.Div(dcc.Input(id='input-text', type='text', value='Enter Username')),
            html.Br(),

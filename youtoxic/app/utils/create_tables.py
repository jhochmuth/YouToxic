...
def create_youtube_table(df, types):
    """Creates a DataTable from youtube comment data.

    Parameters
    ----------
    df : DataFrame
        A DataFrame containing information about the comment posted on a youtube video.
    types : list of str
        The types of toxicity.
